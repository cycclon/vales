Public Class clsEmpresa
    ...
    Private Sub New(ByVal prEmpresa As enEmpresas)
        Select Case prEmpresa
            ...
            Case enEmpresas.Melipal
                Me.xEmpresa = New clsMelipal
        End Select
    End Sub
...
#Region "Clases Anidadas"
    ...
    Private Class clsMelipal : Inherits clsStrategyEmpresa

        Public Overrides ReadOnly Property pdDirección() As String
            Get
                Return "Ángel Vicente Peñaloza 820 | San Nicolás de Bari y Portezuelo"
            End Get
        End Property
        ...
        Public Overrides ReadOnly Property pdEncabezado() As System.Drawing.Image
            Get
                Return My.Resources.Encabezadoml
            End Get
        End Property
