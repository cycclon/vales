...
Public Class frmImprimir
    ...
    Private Sub Imprimir(ByVal sender As Object, ByVal e As PrintPageEventArgs)
        ...
        For i As Integer = 0 To xLimiteBucle
            ...
            e.Graphics.DrawString("ESSO", New Font("Century Gothic", 8, FontStyle.Regular), Brushes.Black, Me.xMVSI(i).X + 11, Me.xMVSI(i).Y + 55)
            ...
            e.Graphics.DrawString(xEmpresa.pdDirección, New Font("Agency FB", 8, FontStyle.Regular), Brushes.Black, Me.xMVSI(i).X + 8, Me.xMVSI(i).Y + 85)
