...
Public Class frmImprimir
    ...
    Private Sub Imprimir(ByVal sender As Object, ByVal e As PrintPageEventArgs)
        ...
        For i As Integer = 0 To xLimiteBucle
            ...
            e.Graphics.DrawString(Me.xEmpresa.pdRazonSocial, New Font("Arial", 16, FontStyle.Bold), Brushes.Black, Me.xMVSI(i).X + xEmpresa.pdPosicionLogo, Me.xMVSI(i).Y + 20)
            e.Graphics.DrawString("AXION ENERGY", New Font("Century Gothic", 12, FontStyle.Regular), Brushes.Black, Me.xMVSI(i).X + 11, Me.xMVSI(i).Y + 55)
            ...
            e.Graphics.DrawString(xEmpresa.pdDirección, New Font("Agency FB", 12, FontStyle.Regular), Brushes.Black, Me.xMVSI(i).X + 8, Me.xMVSI(i).Y + 85)
            ...
            'VALE
            e.Graphics.DrawString("Se autoriza al cliente: " & xVales(xIndiceVale).pdCliente.pdNombreCompleto & ", a cargar", New Font("Verdana", 8, FontStyle.Bold), Brushes.Black, Me.xMVSI(i).X + 10, Me.xMVSI(i).Y + 110)
            e.Graphics.DrawString("combustible por", New Font("Verdana", 8, FontStyle.Bold), Brushes.Black, Me.xMVSI(i).X + 10, Me.xMVSI(i).Y + 125)
            If Me.xVales(xIndiceVale).pdTipo = enTipoVale.Dinero Then e.Graphics.DrawString("un valor equivalente en pesos:", New Font("Verdana", 8, FontStyle.Bold), Brushes.Black, Me.xMVSI(i).X + 120, Me.xMVSI(i).Y + 125)
            ...
            e.Graphics.DrawString("VALE POR:", New Font("Times New Roman", 20, FontStyle.Bold), Brushes.Black, Me.xMVSI(i).X + 20, Me.xMVSI(i).Y + 175)
            If Me.xVales(xIndiceVale).pdTipo = enTipoVale.Dinero Then e.Graphics.DrawString("$", New Font("Times New Roman", 24, FontStyle.Bold), Brushes.Black, Me.xMVSI(i).X + 190, Me.xMVSI(i).Y + 163)
            e.Graphics.DrawString(Me.xVales(xIndiceVale).pdValor.ToString, New Font("Arial", 40, FontStyle.Bold), Brushes.Black, Me.xMVSI(i).X + 210, Me.xMVSI(i).Y + 145)
            If Me.xVales(xIndiceVale).pdTipo = enTipoVale.Combustible Then e.Graphics.DrawString("lts.", New Font("Times New Roman", 24, FontStyle.Bold), Brushes.Black, Me.xMVSI(i).X + 320, Me.xMVSI(i).Y + 163)

            'ACLARACION
            e.Graphics.DrawString("El presente no puede ser canjeado por dinero en efectivo.", New Font("Verdana", 8, FontStyle.Italic), Brushes.Black, Me.xMVSI(i).X + 10, Me.xMVSI(i).Y + 200)
            e.Graphics.DrawString("El monto de este vale es indivisible.", New Font("Verdana", 8, FontStyle.Italic), Brushes.Black, Me.xMVSI(i).X + 10, Me.xMVSI(i).Y + 215)
            e.Graphics.DrawString("LA GERENCIA", New Font("Verdana", 8, FontStyle.Underline), Brushes.Black, Me.xMVSI(i).X + 260, Me.xMVSI(i).Y + 215)

            'VENCIMIENTO
            e.Graphics.DrawString("Válido hasta el:", New Font("Verdana", 10, FontStyle.Regular), Brushes.Black, Me.xMVSI(i).X + 80, Me.xMVSI(i).Y + 240)
            e.Graphics.DrawString(Format(Me.xVales(xIndiceVale).pdVencimiento, "dd/MM/yyyy"), New Font("Verdana", 12, FontStyle.Bold), Brushes.Black, Me.xMVSI(i).X + 190, Me.xMVSI(i).Y + 238)
        Next
