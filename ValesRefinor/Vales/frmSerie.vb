...
Public Class frmSerie
    ...
    Private Sub MostrarSerie()
        Try
            With Me.xSerie
                ...
                End If
                Me.btnEliminar.Visible = (.pdEstadoSerie = enEstadoSerie.Activa)
                Me.btnRestaurar.Visible = (.pdEstadoSerie = enEstadoSerie.Eliminada)
    ...
    Private Sub btnVolver_Click(sender As Object, e As EventArgs) Handles btnVolver.Click
        frmSeries.pdCliente = Me.xSerie.pdCliente
        Navegacion.clsGestorFormularios.Abrir(Navegacion.enFormulario.VerEmisiones, "")
    End Sub

    Private Sub btnEliminar_Click(sender As Object, e As EventArgs) Handles btnEliminar.Click
        Try
            If MsgBox("Esta acción eliminará esta serie y todos sus vales, ¿está seguro que desea continuar?",
                      MsgBoxStyle.YesNo, xTitulo & "Eliminar serie") = MsgBoxResult.Yes Then
                Me.xSerie.Eliminar()
            End If

            Me.CtrlMensaje.pdTipo = ctrlMensaje.enTipoMensaje.Mensaje
            Me.CtrlMensaje.pdMensaje = "La serie fue eliminada correctamente."
    ...
    Private Sub btnRestaurar_Click(sender As Object, e As EventArgs) Handles btnRestaurar.Click
        Try
            If MsgBox("Esta acción restaurará esta serie y todos sus vales (excepto aquellos ya descargados), ¿está seguro que desea continuar?",
                      MsgBoxStyle.YesNo, xTitulo & "Restaurar serie") = MsgBoxResult.Yes Then
                Me.xSerie.Restaurar()
            End If

            Me.CtrlMensaje.pdTipo = ctrlMensaje.enTipoMensaje.Mensaje
            Me.CtrlMensaje.pdMensaje = "La serie fue restaurada correctamente."
